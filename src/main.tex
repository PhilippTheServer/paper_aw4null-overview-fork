...
such as multiple OBD-II variants (SAE J1850, ISO 9141-2, ISO 15765/CAN) and manufacturer-specific protocols like UDS or VW's VCDS\cite{obd2_protocols, obd2_wiki, vcds}.
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.8\textwidth]{figures/ignition_pulse.jpeg}
  \caption{Oscilloscope capture of an ignition secondary waveform showing coil saturation, current control, burn line, and high-voltage spike. Image adapted from diagnostic training material (2006).}
