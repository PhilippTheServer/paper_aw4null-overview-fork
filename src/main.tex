...
% \author{
% \IEEEauthorblockN{Stephan Bökelmann}
% \IEEEauthorblockA{\textit{Ruhr University Bochum}\\
% Bochum, Germany \\
% sboekelmann@ep1.rub.de}
% \and
% \IEEEauthorblockN{René Glitza}
% \IEEEauthorblockA{\textit{Ruhr University Bochum}\\
% Bochum, Germany \\
% rene.glitza@rub.de}
% \and
% \IEEEauthorblockN{Meihui Huang (\zh{黄美慧})}
% \IEEEauthorblockA{\textit{nabla B engineering UG}\\
% Bochum, Germany \\
% meihui@nabla-b.engineering}
% \and
% \IEEEauthorblockN{Odin Holmes}
% \IEEEauthorblockA{\textit{Auto-Intern GmbH}\\
% Bochum, Germany \\
% odin.holmes@auto-intern.de}
% \and
% \IEEEauthorblockN{Lukas Jakubczyk}
% \IEEEauthorblockA{\textit{THGA Bochum}\\
% Bochum, Germany \\
% lukas.jakubczyk@thga.de}
% \and
% \IEEEauthorblockN{Tabea Röthemeyer}
% \IEEEauthorblockA{\textit{Auto-Intern GmbH}\\
% Bochum, Germany \\
% tabea.roethemeyer@auto-intern.de}
% }
...
% Keywords
\begin{IEEEkeywords}
AI diagnostics, federated learning, automotive workshops, oscilloscopes, GAIA-X, REST, WebSocket
\end{IEEEkeywords}
